...
RUN wget http://snapshot.debian.org/archive/debian/20130319T033933Z/pool/main/o/openssl/libssl1.0.0_1.0.1e-2_amd64.deb -O /tmp/libssl_amd64.deb && \
 dpkg -i /tmp/libssl_amd64.deb

ENV DEBIAN_FRONTEND noninteractive

# Setup target web server and enable SSL based Apache instance
